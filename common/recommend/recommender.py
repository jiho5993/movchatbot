...
class Recommender:
    def __init__(self, req):
        ...
        if self.isUser:
            ...
            try:
                self.user_reco_data = self.Reco_Model_df[int(self.user_id)-1]
                # self.user_reco_data = self.Reco_Model_df[1100]
                # self.user_reco_data = self.Reco_Model_df[800]
            except:
                self.isUser = False
